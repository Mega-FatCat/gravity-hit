...
function tutorial(){
 ...
 if(sim.mode==='ignite')return ['04 / THE RITUAL','Find the balance.','Hold LMB and aim at the loaded pipe. A / D tilts the lighter. Release SPACE to draw water out and smoke in; hold it again at 10–20% water.'];
