...
function menuContent(){
 ...
 return `<div class="credits">STILLWATER · Version 1.0<br>A first-person forest simulation.<br><br>Forest scans and environment lighting: Poly Haven, CC0.<br>Fern 02 · Pine Tree 01 · Forest Slope · Leaves Forest Ground · Bark Brown 02 · Rock Boulder Dry.<br><br>Graphics: Three.js, three-gpu-pathtracer, three-mesh-bvh.<br>Windows runtime: Electron. Soundscape and interaction models created for this game.<br><br>All assets are included locally. The game works offline.</div>`;
}
