...
const files=['src/clutter.js','src/environment.js','src/foliage-mipmaps.js','src/foliage-rendering.js','src/atmosphere.js','src/world.js'];
...
try{
 ...
 const views=[['01-stream-banks',0,-.32],['02-left-bank',.75,-.36],['03-right-ground',-.85,-.35],['04-rear-ground',3.14,-.38]];
 ...
 const report=await session.finalize({errors,extraMeta:{scope:'Dry-bank and midground ground infill',status:'CURRENT BUILD NEEDS MANUAL CHECK',hashes:after}});
