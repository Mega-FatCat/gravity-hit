...
const app=await electron.launch({args:[path.resolve(process.argv[3]||'.'),'--qa','--benchmark'],executablePath:path.resolve('node_modules/electron/dist/electron.exe'),timeout:90000});
