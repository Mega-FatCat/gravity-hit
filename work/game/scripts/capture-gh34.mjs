...
const outDir = path.resolve(process.argv[2] || 'qa/gh34-evidence');
...
try {
  ...
  const manifest = await session.finalize({
    warning: 'GH-34 terrain-detail contact and embedding verification fixtures.',
    errors,
    extraMeta: {
      scope: 'GH-34 improved contact, orientation to ground normal, partial embedding, horizontal pine cones, zero floating assets'
    }
  });
